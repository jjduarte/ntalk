...
describe('No controller contatos', function () {
    ...
    describe('o usuário logado', function () {
        var login = {usuario: {nome: 'Teste', email: 'teste@teste.com'}}
          , contato = {contato: {nome: 'TesteContato', email: 'contato@teste.com'}}
          , cookie = {}
          ;
        ...
        it('deve ir para rota /contatos em POST /contato', function (done) {
            var contato = {contato: {nome: 'TesteContato', email: 'contato@teste.com'}};
